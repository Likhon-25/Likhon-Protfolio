    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {["React", "Node.js", "MongoDB", "Express", "TypeScript"].map(
              (t) => (
                <span
                  key={t}
                  style={{
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          A curated set of technologies I use to build full-stack applications
...
const projects = [
  {
    id: 1,
    icon: "🍽️",
    title: "Modern Hearth Restaurant",
  ...
  },
  {
    ...
    techs: ["JavaScript", "Tailwind CSS", "DaisyUI"],
  ...
  },
  {
    ...
    techs: ["JavaScript ES6", "Tailwind CSS", "DaisyUI"],
    tags: ["javascript", "tailwind"],
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          A selection of real-world projects demonstrating my skills across the
          full stack.
        </p>
      </motion.div>
        ...
        {filters.map((f) => (
          <button
            ...
            style={{
              ...
              background:
                active === f.value ? "rgba(56,189,248,0.08)" : "transparent",
